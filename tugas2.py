...
known_face_encodings = [jungkook_face_encodings, J-hope_face_encodings]
known_face_names = ["Jeon Jungkook", "Jung ho-seok"]
known_face_job = ["member BTS", "member BTS"
...
while (file_video_stream.isOpened):
    ...
    for current_face_location,current_face_encoding in zip(all_face_locations,all_face_encodings):
        ...
        if True in all_matches:
            ...
            job_of_person = known_face_job[first_match_index]
        ...
        cv2.putText(current_frame, name_of_person, (left_pos,bottom_pos), font, 0.5, (255,255,0),1)
        cv2.putText(current_frame, job_of_person, (left_pos,top_pos), font, 0.5, (255,255,255),2)
    #display the video
    cv2.imshow("Tugas Individu 2",current_frame)
